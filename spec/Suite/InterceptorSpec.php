...
describe("Interceptor", function() {
    ...
    describe("->findFile()", function() {
        ...
        it("deletages finds to patched autoloader", function() {
            ...
            expect($this->autoloader)->toReceive('findFile')->with('Lead\Jit\Spec\Fixture\Interceptor\ClassA');

            $interceptor = Interceptor::instance();
            $actual = $interceptor->findFile('Lead\Jit\Spec\Fixture\Interceptor\ClassA');
    ...
    describe("->loadFiles()", function() {
        ...
        it("loads a file", function() {
            ...
            expect(class_exists('Lead\Jit\Spec\Fixture\Interceptor\ClassB', false))->toBe(true);
            expect(class_exists('Lead\Jit\Spec\Fixture\Interceptor\ClassC', false))->toBe(true);
    ...
    describe("->loadClass()", function() {
        ...
        it("loads a class", function() {
            ...
            expect($interceptor->loadClass('Lead\Jit\Spec\Fixture\Interceptor\ClassD'))->toBe(true);
            expect(class_exists('Lead\Jit\Spec\Fixture\Interceptor\ClassD', false))->toBe(true);
        ...
        it("returns null when the class can't be loaded", function() {
            ...
            expect($interceptor->loadClass('Lead\Jit\Spec\Fixture\Interceptor\ClassUnexisting'))->toBe(null);
    ...
    describe("->findPath()", function() {
        ...
        it("finds a namespace path", function() {
            ...
            expect($interceptor->findPath('Lead\Jit\Spec\Fixture\Interceptor'))->toBe($expected);
        ...
        it("finds a PHP class path", function() {
            ...
            $expected = realpath('spec/Fixture/Interceptor/ClassA.php');
            expect($interceptor->findPath('Lead\Jit\Spec\Fixture\Interceptor\ClassA'))->toBe($expected);
        ...
        it("finds a HH class path", function() {
            ...
            expect($interceptor->findPath('Lead\Jit\Spec\Fixture\Interceptor\ClassHh'))->toBe($expected);
        ...
        it("forces the returned path to be a directory", function() {
            ...
            expect($interceptor->findPath('Lead\Jit\Spec\Fixture\Interceptor\ClassA', true))->toBe($expected);
